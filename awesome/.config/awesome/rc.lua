...
globalkeys = gears.table.join(
    ...
    awful.key(
        ...
        { description = 'go back i.e fetch the last tag', group = 'tag' }
    ),
    ...
    end, { description = 'go back i.e fetch the last focused window', group = 'client' }),
    ...
    end, { description = 'spawn dmenu ', group = 'launcher' })
)
